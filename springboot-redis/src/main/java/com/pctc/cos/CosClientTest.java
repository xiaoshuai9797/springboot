...
public class CosClientTest {
    ...
    private static final String KEY="ppkkdd/dd2.jpg";
    ...
    public static String uploadFile() {
        File localFile = new File("D:\\dd2.jpg");
        //KEY可以存在，也可以不存在
       // PutObjectRequest putObjectRequest = new PutObjectRequest(BUCKETNAME, KEY, localFile);

        PutObjectRequest putObjectRequest = new PutObjectRequest(BUCKETNAME, "ppkkdd/dd2.jpg", localFile);
    ...
    public static String downLoadFile(String bucketName, String key) {
        File downFile = new File("D:\\temppkd\\1.jpg");
        COSClient cc = getCosClient();
    ...
    public static void main(String[] args) {
      ...
      /*  boolean exists=doesBucketExist("pkd-1304170952");
...
/*
      ...
      // System.out.println("BUCKETNAME的位置：" + getBucketLocation(BUCKETNAME));
       ...
       //   createBucket("pkd-1304170952");

       // deleteBucket("examplebucket-1304170952");
